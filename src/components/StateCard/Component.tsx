...
export const StateCard: React.FC<StateCardProps> = ({
	...
	return (
		<TiltCard className="relative col-span-4 rounded-3xl overflow-hidden h-56">
			{isComingSoon && (
			...
			<div className="absolute flex justify-end p-5 flex-col z-20 w-full h-full">
				<h4 className="font-bold text-4xl">{stateName}</h4>
			</div>
			...
			<Image className="absolute z-0 h-full" {...image} />
		</TiltCard>
	);
};
